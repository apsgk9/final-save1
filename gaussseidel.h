...
* File: gaussseidel.h Date: 5/10/20
* Class: CS 5201
...
/*! \file
 *
 * A gaussseidel method solver library.
 */
#include "solverInterface.h"


#ifndef GUASSSEIDEL_H
#define GUASSSEIDEL_H
  class gaussseidel : public virtual solverInterface<double>
{
private:
...
public:
  ...
  */
  gaussseidel(double input_threshold = 0.02);
